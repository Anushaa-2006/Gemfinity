...
- **Interactive Savings Dashboard:** Circular progress indicators, benchmark 22K gold weight accumulator (~₹6,850/g), and next due date countdown.
- **Scheme Collections:** Group individual family chit funds into named sets (e.g., *"Bridal Jewellery Fund 2026"*).
...
- **Theme System:** Multi-theme support (**Luxury Gold**, **Fintech Minimal**, **Trust & Community**).

---

## 🛠️ Tech Stack & Specifications
* **Frontend Mobile App:** React Native / React 18, Lucide Icons, QRCode SVG, `react-i18next`.
